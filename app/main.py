...
from app.tasks.health_checkin_tasks import start_health_checkin_tasks
import asyncio
...
async def lifespan(app: FastAPI):
    try:
        ...
        # Start health check-in background tasks
        asyncio.create_task(start_health_checkin_tasks())
        logger.info("Health check-in background tasks started.")
...
app.add_middleware(
    SessionMiddleware,
    secret_key="dev-dummy-key-123"  # You can change this later for production
)
